...
//     let statement = input("Enter question statement... ");
//     let noOfOptions = readlineSync.questionInt("Enter number of options you want for this question? ");
//     let options = [];
//     for(let i = 0;i < noOfOptions;i++) {
//         options.push( input(`Enter option ${i + 1} `) );
//     }
//     let answerIndex = readlineSync.keyInSelect(options, "Enter answer for this question ");
//     return {
//         statement,
//         options,
//         answerIndex
...
// function makeQuiz() {
//     let quiz = [];
//     let quizName = input("Enter title of your quiz");
//     quiz.push( { quizName });
//     let noOfQuestions = readlineSync.questionInt("Enter number of questions you want in quiz? ");
...
//     console.log(metaDataObj.quizName);
//     quiz.forEach(question => {
//         let ans = readlineSync.keyInSelect(question.options, question.statement)
...
// let choice = 0;
// do {
//     choice = readlineSync.keyIn("Press 1 for creating your own quiz, 2 for taking existing quiz and 3 for exiting", {limit: '$<1-3>'});
//     if(choice == 1) {
//         let quiz = makeQuiz();
//         saveQuiz(quiz);
//     }
